...
public class CcnaCoursePage extends BaseObject {
	...
	@FindBy(xpath = "/html/body/main/section[12]")
	private WebElement conclusion;

	@FindBy(xpath = "/html/body/main/section[13]")
	...
	public void uptoClickingCcnaCourse() {
	...
	public boolean isTestimonialsDisplayed() {
		return testimonials.isDisplayed();
	}

	public boolean isConclusionDisplayed() {
		return conclusion.isDisplayed();
	}
